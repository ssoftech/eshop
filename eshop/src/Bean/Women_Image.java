...
public class Women_Image {
	...
	public Women_Image(String product_Id, String color, InputStream image,
			String filename) {
		super();
	...
	public Women_Image(String product_Id, String color, String size) {
		super();
		Product_Id = product_Id;
		Color = color;
		Size = size;
