...
@WebServlet("/Retailer_Men_Edit_Color")
public class Retailer_Men_Edit_Color extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		try {
			...
			String sql="Update retailer_colorinsertmen set ColorName=?, Quantity=? where ColorId=? And Product_Id=? ";
			...
			if(i>0)
			{
				...
				String sql11="Update retailer_imageinsrt_men set ColorName=? where ColorId=? And Product_Id=?";
				...
				String sql18="Update retailer_sizeinsrt_men set ColorName=? where ColorId=? And Product_Id=?";
				...
				int Qty2=0;
				String sql6="Select sum(Quantity) from retailer_colorinsertmen where Product_Id=?";
				...
				{
					Qty2=rs6.getInt(1);
					String sql9="Update retailer_totalqty set TotalQuantity=? where Product_Id=?";
