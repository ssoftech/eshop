...
@WebServlet("/Retaler_Kids_InsertImage")
@MultipartConfig(maxFileSize = 1024 * 1024 * 16)
public class Retaler_Kids_InsertImage extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request,
		...
		try {			
			...
			if(image_1!= null && !filename1.equals("")) {
				 Retailer_Kids_Image obj = new Retailer_Kids_Image(Product_Id, Color, is_1, filename1);
				 k=Model.Model_Retailer_Kids_Prdct.Insert_Image(obj);
			}
			
			if(image_2!= null && !filename2.equals("")) {
				 Retailer_Kids_Image obj = new Retailer_Kids_Image(Product_Id, Color, is_2, filename2);
				 k=Model.Model_Retailer_Kids_Prdct.Insert_Image(obj);
			}
			
			if(image_3!= null && !filename3.equals("")) {
				 Retailer_Kids_Image obj = new Retailer_Kids_Image(Product_Id, Color, is_3, filename3);
				 k=Model.Model_Retailer_Kids_Prdct.Insert_Image(obj);
			}
			
			if(image_4!= null && !filename4.equals("")) {
				 Retailer_Kids_Image obj = new Retailer_Kids_Image(Product_Id, Color, is_4, filename4);
				 k=Model.Model_Retailer_Kids_Prdct.Insert_Image(obj);
			}
			
			if(image_5!= null && !filename5.equals("")) {
				 Retailer_Kids_Image obj = new Retailer_Kids_Image(Product_Id, Color, is_5, filename5);
				 k=Model.Model_Retailer_Kids_Prdct.Insert_Image(obj);
			}
			...
			if(!Size1.equals("")) {
				Retailer_Kids_Image obj2 = new Retailer_Kids_Image(Product_Id, Color, Size1);
				k=Model.Model_Retailer_Kids_Prdct.Insert_Size(obj2);
			}
			
			if(!Size2.equals("")) {
				Retailer_Kids_Image obj2 = new Retailer_Kids_Image(Product_Id, Color, Size2);
				k=Model.Model_Retailer_Kids_Prdct.Insert_Size(obj2);
			}
			
			if(!Size3.equals("")) {
				Retailer_Kids_Image obj2 = new Retailer_Kids_Image(Product_Id, Color, Size3);
				k=Model.Model_Retailer_Kids_Prdct.Insert_Size(obj2);
			}
			
			if(!Size4.equals("")) {
				Retailer_Kids_Image obj2 = new Retailer_Kids_Image(Product_Id, Color, Size4);
				k=Model.Model_Retailer_Kids_Prdct.Insert_Size(obj2);
			}
			
			if(!Size5.equals("")) {
				Retailer_Kids_Image obj2 = new Retailer_Kids_Image(Product_Id, Color, Size5);
				k=Model.Model_Retailer_Kids_Prdct.Insert_Size(obj2);
			}
