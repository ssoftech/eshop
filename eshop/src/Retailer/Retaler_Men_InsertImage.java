...
@WebServlet("/Retaler_Men_InsertImage")
@MultipartConfig(maxFileSize=1024*1024*16)
public class Retaler_Men_InsertImage extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		try {
			  ...
			  int colorid=0;
			  colorid=Model.Model_Retailer_Men_Prdct.Select_Color(Color, Product_Id);
			 ...
			 {
				 Retailer_Men_Image obj=new Retailer_Men_Image(Product_Id, Color, is_1, filename1, colorid);
				 k=Model.Model_Retailer_Men_Prdct.Insert_Image(obj);
			 ...
			 {
				Retailer_Men_Image obj=new Retailer_Men_Image(Product_Id, Color, is_2, filename2, colorid);
				 k=Model.Model_Retailer_Men_Prdct.Insert_Image(obj);
			 ...
			 if(image_3!=null && !filename3.equals(""))
			 {
				 ...
				 Retailer_Men_Image obj= new Retailer_Men_Image(Product_Id, Color, is_3, filename3, colorid);
				 k=Model.Model_Retailer_Men_Prdct.Insert_Image(obj);
			 ...
			 {
				 Retailer_Men_Image obj= new Retailer_Men_Image(Product_Id, Color, is_4, filename4, colorid);
				 k=Model.Model_Retailer_Men_Prdct.Insert_Image(obj);
			 ...
			 {
				 Retailer_Men_Image obj= new Retailer_Men_Image(Product_Id, Color, is_5, filename5, colorid);
				 k=Model.Model_Retailer_Men_Prdct.Insert_Image(obj);
			...
			//Size Insert
			 ...
			 if(!Size1.equals(""))
			 {
				 Retailer_Men_Image obj2=new Retailer_Men_Image(Product_Id, Color, Size1, colorid);
				 l=Model.Model_Retailer_Men_Prdct.Insert_Size(obj2);
			 }
			 
			 if(!Size2.equals(""))
			 {
				 Retailer_Men_Image obj2=new Retailer_Men_Image(Product_Id, Color, Size2, colorid);
				 l=Model.Model_Retailer_Men_Prdct.Insert_Size(obj2);
			 }
			 
			 if(!Size3.equals(""))
			 {
				 Retailer_Men_Image obj2=new Retailer_Men_Image(Product_Id, Color, Size3, colorid);
				 l=Model.Model_Retailer_Men_Prdct.Insert_Size(obj2);
			 }
			 
			 if(!Size4.equals(""))
			 {
				 Retailer_Men_Image obj2=new Retailer_Men_Image(Product_Id, Color, Size4, colorid);
				 l=Model.Model_Retailer_Men_Prdct.Insert_Size(obj2);
			 }
			 
			 if(!Size5.equals(""))
			 {
				 Retailer_Men_Image obj2=new Retailer_Men_Image(Product_Id, Color, Size5, colorid);
				 l=Model.Model_Retailer_Men_Prdct.Insert_Image(obj2);
			 }
