...
@WebServlet("/Retailer_Women_InsertColor")
public class Retailer_Women_InsertColor extends HttpServlet {
	private static final long serialVersionUID = 1L;

	protected void doPost(HttpServletRequest request,
			HttpServletResponse response) throws ServletException, IOException {
		// Insert Color and Quantity
		...
		try{
			...
			if (request.getParameter("Color1") != ""
			...
			if (request.getParameter("Color2") != ""
			...
			if (request.getParameter("Color3") != ""
			...
			if (request.getParameter("Color4") != ""
			...
			if (request.getParameter("Color5") != ""
			...
			if (Color1 != "" && Quantity1 != 0) {
				Retailer_Women_Color obj = new Retailer_Women_Color(Product_Id,
						Color1, Quantity1);
				i = Model.Model_Retailer_Women_Prdct.Insert_Color(obj, Color1);
				if (i == 0) {
					msg = Color1 + "";
				}
			}
			...
			if (Color2 != "" && Quantity2 != 0) {
				Retailer_Women_Color obj = new Retailer_Women_Color(Product_Id,
						Color2, Quantity2);
				i = Model.Model_Retailer_Women_Prdct.Insert_Color(obj, Color2);
				if (i == 0) {
					msg = msg + Color2 + " ";
				}
			}
			...
			if (Color3 != "" && Quantity3 != 0) {
				Retailer_Women_Color obj = new Retailer_Women_Color(Product_Id,
						Color3, Quantity3);
				i = Model.Model_Retailer_Women_Prdct.Insert_Color(obj, Color3);
				if (i == 0) {
					msg = msg + Color3 + " ";
				}
			}
			...
			if (Color4 != "" && Quantity4 != 0) {
				Retailer_Women_Color obj = new Retailer_Women_Color(Product_Id,
						Color4, Quantity4);
				i = Model.Model_Retailer_Women_Prdct.Insert_Color(obj, Color4);
				if (i == 0) {
					msg = msg + Color4 + " ";
				}
			}
			...
			if (Color5 != "" && Quantity5 != 0) {
				Retailer_Women_Color obj = new Retailer_Women_Color(Product_Id,
						Color5, Quantity5);
				i = Model.Model_Retailer_Women_Prdct.Insert_Color(obj, Color5);
				if (i == 0) {
					msg = msg + Color5 + " ";
				}
			}
			...
			if (Quantity1 != 0 || Quantity2 != 0 || Quantity3 != 0
				...
				int k = Model.Model_Retailer_Women_Prdct
						.InsertTotalQuantity(Product_Id);
			}
