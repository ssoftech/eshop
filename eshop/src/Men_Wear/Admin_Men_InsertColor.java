...
@WebServlet("/Admin_Men_InsertColor")
public class Admin_Men_InsertColor extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		//Color Insert
				...
				try {
					...
					{
						Men_Color obj=new Men_Color(Product_Id, Color1, Quantity1);
						 i=Model.Model_Men_Prdct.Insert_Color(obj,Color1);
						 if(i==0)
						 {
							 msg=Color1+" ";
						 }
					...
					{
						Men_Color obj=new Men_Color(Product_Id, Color2, Quantity2);
						 i=Model.Model_Men_Prdct.Insert_Color(obj,Color2);
						 if(i==0)
						 {
							 msg=msg+Color2+" ";
						 }
					...
					{
						Men_Color obj=new Men_Color(Product_Id, Color3, Quantity3);
						 i=Model.Model_Men_Prdct.Insert_Color(obj,Color3);
						 if(i==0)
						 {
							 msg=msg+Color3+" ";
						 }
					...
					{
						Men_Color obj=new Men_Color(Product_Id, Color4, Quantity4);
						i=Model.Model_Men_Prdct.Insert_Color(obj,Color4);
						if(i==0)
						 {
							 msg=msg+Color4+" ";
						 }
					...
					{
						Men_Color obj=new Men_Color(Product_Id, Color5, Quantity5);
						i=Model.Model_Men_Prdct.Insert_Color(obj,Color5);
						if(i==0)
						 {
							 msg=msg+Color5+" ";
						 }
					...
					{
						int k=Model.Model_Men_Prdct.InsertTotalQuantity(Product_Id);
					}
