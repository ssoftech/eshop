...
@WebServlet("/Admin_Men_InsertImage")
@MultipartConfig(maxFileSize=1024*1024*16)
public class Admin_Men_InsertImage extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		//Image Insert
				...
				try {
					 ...
					 {
						 Men_Image obj= new Men_Image(Product_Id, Color, is_1, filename1);
						 k=Model.Model_Men_Prdct.Insert_Image(obj);
					 ...
					 {
						 Men_Image obj= new Men_Image(Product_Id, Color, is_2, filename2);
						 k=Model.Model_Men_Prdct.Insert_Image(obj);
					 ...
					 if(image_3!=null && !filename3.equals(""))
					 {
						 ...
						 Men_Image obj= new Men_Image(Product_Id, Color, is_3, filename3);
						 k=Model.Model_Men_Prdct.Insert_Image(obj);
					 ...
					 {
						 Men_Image obj= new Men_Image(Product_Id, Color, is_4, filename4);
						 k=Model.Model_Men_Prdct.Insert_Image(obj);
					 ...
					 {
						 Men_Image obj= new Men_Image(Product_Id, Color, is_5, filename5);
						 k=Model.Model_Men_Prdct.Insert_Image(obj);
			...
			//Size Insert
					 ...
					 if(!Size1.equals(""))
					 {
						 Men_Image obj2=new Men_Image(Product_Id, Color, Size1);
						 l=Model.Model_Men_Prdct.Insert_Size(obj2);
					 }
					 
					 if(!Size2.equals(""))
					 {
						 Men_Image obj2=new Men_Image(Product_Id, Color, Size2);
						 l=Model.Model_Men_Prdct.Insert_Size(obj2);
					 }
					 
					 if(!Size3.equals(""))
					 {
						 Men_Image obj2=new Men_Image(Product_Id, Color, Size3);
						 l=Model.Model_Men_Prdct.Insert_Size(obj2);
					 }
					 
					 if(!Size4.equals(""))
					 {
						 Men_Image obj2=new Men_Image(Product_Id, Color, Size4);
						 l=Model.Model_Men_Prdct.Insert_Size(obj2);
					 }
					 
					 if(!Size5.equals(""))
					 {
						 Men_Image obj2=new Men_Image(Product_Id, Color, Size5);
						 l=Model.Model_Men_Prdct.Insert_Size(obj2);
					 }
						...
						response.sendRedirect("Admin_Men_InsertPrdct.jsp?Mssg="+ms);	
				} 
				catch (Exception e) 
				{
