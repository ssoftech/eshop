...
// Automatically adds Zero after Pice
	function fixit( obj ) {
...
<body>
	...
	<div id="container">
		...
		<div id="content">
			...
			<form action="Retailer_Men_Insrt_Prdct" method="post">
				<%
				...
				<table id="ProductEntry" align="center"
					...
					<tr>
						<td style="padding-left: 5%;"><input type="text"
							name="Product_SoldBy" id="Product_SoldBy" value="<%=name %>" readonly="readonly"
							placeholder="Retailer Name" size="39"></td>
					...
					<tr>
						<td style="padding-left: 5%;" id="unit"><select name="Units" style="width:172px; margin-left:-135px; height: 27px;">
						<option value="id" selected="selected">Select the unit here</option>
						
						</select></td>
						
						<td><input type="text" name="qty" size="14" style="margin-top: 4px; margin-left: -270px;" placeholder="No. of units"></td>
					...
					<tr>
						<td style="padding-left: 5%;"><input type="text" name="Price"
							...
							onblur="return PriceValidate()" onchange="fixit(this)"></td>
						<td id="priceloc"></td>
					</tr>
			...
			<form action="Retailer_Men_InsertColor" method="post">
						...
						<td colspan="2"><select name="Product_Id"
							onchange="show_color(this.value)">
								...
								<%
									...
									String sql4 = "Select Product_Id from retailer_productinsertmen a1 inner join Retailer_Register a2 on a1.Retailer_Name=a2.FirstName and Email=? ";
			...
			<form action="Retaler_Men_InsertImage" method="post"
						...
						<td><select name="Image_Table2" id="Image_Table2"
							onchange="show_colorforimage(this.value)">
								...
								<%
									...
									String sql6 = "Select Product_Id from retailer_productinsertmen a1 inner join Retailer_Register a2 on a1.Retailer_Name=a2.FirstName and Email=?";
