...
<title>xyzshop grocery section</title>
<style>
body {
				...
				<div id='leftMenu'>
					...
					<ul>
						...
						<li class='has-sub'><a href='#'><span>PRICE</span></a>
							<ul>
								<li><a href="#"
									onclick="showPrice1('500','<%=Type%>','<%=Category%>')"><span>Below
											500</span></a></li>
								<li><a href="#"
									onclick="showPrice2('500-799','<%=Type%>','<%=Category%>')"><span>500-799</span></a></li>
								<li><a href="#"
									onclick="showPrice3('800-999','<%=Type%>','<%=Category%>')"><span>800-999</span></a></li>
								<li><a href="#"
									onclick="showPrice4('1000-1499','<%=Type%>','<%=Category%>')"><span>1000-1499</span></a></li>
								<li><a href="#"
									onclick="showPrice5('1499','<%=Type%>', '<%=Category%>')"><span>Above
											1499</span></a></li>
