			...
			<table>
				<tr
					...
					<td style="padding-left: 11.3%; position: static; z-index: 9999;"
						id="image"><img
						src="Image_Small?pid=<%=Product_id%> &FileName=<%=filename%>"
				...
				<tr id="subThumb">
					<td
						...
						href="MenShirtsRed1.jsp?Pid=<%=Product_id%> &Category=<%=category%> &Filename=<%=file%> &Price=<%=price%> &Colorname=<%=Color%>"><img
							src="Image_Small?pid=<%=Product_id%> &FileName=<%=file%>" style="width:50px; height:90px;"></img></a>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
						<%
 	}
 %>
					</td>
