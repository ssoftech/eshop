...
<body>
	<div id="container"><!-- This is wrapper div -->
		...
		<div id="content"><!-- This is the content div -->
            ...
            <th style="padding: 10px;">Return Reason</th>
            <th style="padding: 10px;">Bank Name</th>
            <th style="padding: 10px;">Ifsc</th>
            <th style="padding-left: 10px; padding-right: 10px;">Bank Account Number</th>
            <th style="padding-left: 10px; padding-right: 10px;">Date of Return Initaited</th>
            </tr>
            <%
Connection con=Conct.conect();
String sql="Select * from return_prdcts ";
...
<td><%=rs.getString("Return_Reason") %></td>
<td><%=rs.getString("BankName") %></td>
<td><%=rs.getString("Ifsc") %></td>
<td><%=rs.getString("Bank_Acc_No") %></td>
