		...
		<div id="body1">
			...
			<div id="loginwrapper">
				...
				<div class="greetUserExt">
					<div class="greetUser">
						<a href="ShowUserDetails.jsp">Welcome <%=username%>
			...
			<div class="body6a">
				<div id='leftMenu'>
					<%
						...
						String sql8 = "Select BrandName from retailer_productinsertwomen where Category=? And Type=?";
			...
			<div class="body6b">
				<table id="body6b">
					<%
						...
						String sql = "Select  DISTINCT ad1.Product_Id, ad1.ColorName from retailer_imageinsrt_women ad1 inner join retailer_productinsertwomen ad2 on ad1.Product_Id=ad2.Product_Id and Type=? and Category=?";
						PreparedStatement ps = con.prepareStatement(sql);
						ps.setString(1, type);
					...
					%><tr>
							...
							for (int i = 1; i <= 3; i++)
								{
									...
									if (rs.next())
									{
										...
										String sql2 = "Select  ad2.Price, ad2.Tagline,ad1.Filename from retailer_imageinsrt_women ad1 inner join retailer_productinsertwomen ad2 on ad1.Product_Id=ad2.Product_Id and ad1.Product_Id=?";
						...
						%><td><table id="MainThumb">
								<tr>
									<td><a 
										href="WomenRed.jsp?Pid=<%=product_id%> &Category=<%=category%> &Price=<%=price%> &Colorname=<%=Colorname%> &Filename=<%=Filename%>">
											<img src="Image_Women?pid=<%=product_id%> " height="340"
											width="240"></img>
									</a></td>
								</tr>
								<tr>
