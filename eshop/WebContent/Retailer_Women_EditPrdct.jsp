...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	pageEncoding="ISO-8859-1" import="java.util.*, Bean.*, Model.*"%>
<!DOCTYPE html>
<html>
<head>
...
<script>
	...
	function show_details(str) {
		if (str.length == 0) {
			...
			xmlhttp.open("GET", "Edit_Retailer_WomenPrdcts.jsp?Retailer_Name="
					+ str, true);
			xmlhttp.send();
		}
	}
	function show_productdetails(str) {
		if (str.length == 0) {
			...
			xmlhttp.open("GET",
					"Edit_RetailerDetailsWomen.jsp?Product_Id=" + str, true);
			xmlhttp.send();
		}
	}
	...
	function show_color(str) {
		if (str.length == 0) {
			...
			xmlhttp.open("GET",
					"Edit_RetailerDetails_ColorWomen.jsp?Product_Id=" + str,
					true);
			xmlhttp.send();
		}
	}
	...
	function show_colorforimage(str) {
		...
		if (str.length == 0) {
			...
			xmlhttp.open("GET",
					"Edit_RetailerDetails_ImageWomenColor.jsp?Product_Id="
							+ str, true);
			xmlhttp.send();
		}
	...
	function show_image_name(str) {
		...
		if (str.length == 0) {
			...
			xmlhttp.open("GET", "Edit_RetailerDetails_WomenImage.jsp?Color="
					+ str + "&Product_Id=" + Product_Id, true);
			xmlhttp.send();
		}
	...
	function show_size(str) {
		...
		if (str.length == 0) {
			...
			xmlhttp.open("GET", "Edit_RetailerDetals_WomenSize.jsp?Color=" + str
					...
					<div
						...
						<div class="tab-content">
							<div id="AddPrd" class="tab-pane fade in active">
								...
								<br> <br>
								<form action="Retailer_Women_EditPrdct" method="post"
										...
										<div class="col-sm-9">
											<select class="form-control" id="category" name="Product_Id"
												...
												<option selected="selected" id="Id">Select Product
													Id....</option>
												 <%
													Retailer_Women_Prdct obj2 = new Retailer_Women_Prdct();
													Iterator<Retailer_Women_Prdct> it2 = arr.iterator();
													while (it2.hasNext()) {
														obj2 = (Retailer_Women_Prdct) it2.next();
												%>
							...
							<div id="AddImg" class="tab-pane fade">
								...
								<form action="Retailer_Women_Edit_Size" method="post"
									class="form-horizontal" role="form">
									<div class="form-group">
										<label class="control-label col-sm-3" for="category"
											style="text-align: left;">Product:</label>
										<div class="col-sm-9">
											<select class="form-control" id="Image_Table2"
												onchange="show_colorforimage(this.value)">
												<option selected="selected">Select Product Id....</option>
												<%
													Retailer_Women_Prdct obj9 = new Retailer_Women_Prdct();
													Iterator<Retailer_Women_Prdct> it9 = arr.iterator();
													while (it9.hasNext()) {
														obj9 = (Retailer_Women_Prdct) it9.next();
												%>
									...
									<div class="form-group">
										...
										<div class="col-sm-9" id="select_2">
											<select class="form-control" id="select_2">
												<option selected="selected" value="Id">Select Color
													Here....</option>
											</select>
										</div>
									</div>
									<div class="col-sm-6" id="image_sizetable"
										style="padding-left: 0px;">
										<input type="text" class="form-control" id="Size1"
											placeholder="Size 1"><br> <input type="text"
											class="form-control" id="Size2" placeholder="Size 2"><br>
										<input type="text" class="form-control" id="Size3"
											placeholder="Size 3"><br> <input type="text"
											class="form-control" id="Size4" placeholder="Size 4"><br>
										<input type="text" class="form-control" id="Size5"
											placeholder="Size 5"><br>
										<button type="submit" class="btn btn-primary btn-block">Edit
											Size</button>
									</div>

									<div class="col-sm-6" id="im"
										style="padding-left: 0px; padding-right: 0px;">
										<input type="file" class="btn btn-default btn-file btn-block"
											id="Image1" data-provides="fileinput"><br> <input
											type="file" class="btn btn-default btn-file btn-block"
											id="Image2" data-provides="fileinput"><br> <input
											type="file" class="btn btn-default btn-file btn-block"
											id="Image3" data-provides="fileinput"><br> <input
											type="file" class="btn btn-default btn-file btn-block"
											id="Image4" data-provides="fileinput"><br> <input
											type="file" class="btn btn-default btn-file btn-block"
											id="Image5" data-provides="fileinput"><br>
									</div>
								</form>
							</div>
						</div>
