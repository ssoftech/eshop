...
<body onload="status()">
	...
	<div id="body1">
		...
		<div id="loginwrapper">
			...
			<div class="greetUserExt">
				<div class="greetUser">
					<a href="User_MyOrder.jsp">Welcome <%=username%> &nbsp&nbsp<i
							...
							<ul>
								...
								<li><a
									href="menshirts.jsp?Type=VestCoats &Category=Formals">Vest
										Coats</a></li>
								<li><a href="menshirts.jsp?Type=Trousers &Category=Formals">Trousers</a></li>
							</ul>
						</div>
					...
					<div class="dropdown_women">
						...
						<div class="col_1">
							...
							<ul>
								...
								<li><a href="grocery.jsp?Type=ColDrinks &Category=Beverage">Cold/Soft
										Drinks</a></li>
	...
	<div id="ShirtThumbTable" class="ShirtThumb1">
		...
		<table>
			...
			<%
				...
				String sql3 = "Select DISTINCT Filename from retailer_imageinsrt_kids where Product_Id=?  AND ColorName=?";
			...
			<tr>
				<td style="padding-left: 18%;" id="image"><img
					src="Image_diffkid_color?pid=<%=Product_id%> &ColorName=<%=Color%>"
 ...
 %> <a
					href="KidsRed.jsp?Pid=<%=Product_id%> &Category=<%=category%> &Filename=<%=file%> &Price=<%=price%> &Colorname=<%=Color%>"><img
						src="Image_diffkid_color12?pid=<%=Product_id%> &ColorName=<%=Color%> &file=<%=file%>"
