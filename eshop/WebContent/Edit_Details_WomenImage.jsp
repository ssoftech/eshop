...
<%
	...
	<table id="im"
		...
		<%
				...
				String sql = "Select Filename from admin_imageinsrt_women where Product_Id=? and ColorName=?";
		...
		<tr>
			<td><a href="Show_ImageAdminWomen_Edit.jsp?Filename=<%=rs.getString("Filename")%>"><%=rs.getString("FileName")%></a></td>
		</tr>
