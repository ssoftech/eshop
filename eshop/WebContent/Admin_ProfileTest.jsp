...
<link rel='stylesheet' type='text/css' href="css/style_adminprofile.css" />
	...
	<div id="container">
		...
		<div id="menu">
			...
			<ul id="navmenu">
				...
				<li class="active"><a href="#">Manage Employee</a>
					<ul class="sub1">
				...
				<li class="active"><a href="#">Manage Reports</a>
					<ul class="sub1">
						...
						<li><a href="#">ProductWise Sales </a></li>
					</ul></li>
			</ul>
		</div>
		...
		<div class="nFeed1">
			<table id="NewsFeedTab1" border="1" rules="cols"
				...
				<tr>
					<td><span style="margin-left: -40px;">Retailer1 added</span> <span>Brand Name</span></td>
				</tr>
				<tr>
					<td><span style="margin-left: -40px;">Retailer1 added</span> <span>Brand Name</span></td>
				</tr>
		...
		<div class="nFeed2">
			<table id="NewsFeedTab2" border="1" rules="cols"
				...
				<tr>
					<td><span>Retailer1</span></td>
				</tr>
				<tr>
					<td><span>Retailer2</span></td>
				</tr>
				<tr>
					<td><span>Retailer3</span></td>
				</tr>
				<tr>
					<td><span>Retailer2</span></td>
				</tr>
