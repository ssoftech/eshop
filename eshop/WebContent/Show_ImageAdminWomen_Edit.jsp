	...
	<div id="container"><!-- This is wrapper div -->
		...
		<div id="content"><!-- This is the content div -->
           ...
           <table  id="show_imageedit" cellspacing="8" >
			...
			String sql="Select * from admin_imageinsrt_women where Filename=?";
            ...
            <td><img src="Show_ImageAdmin_Women?FileName=<%=rs.getString("Filename")%>" height="130" width="130"  alt="kk" class="thumbnail"></td>
            <td><%=rs.getString("Filename") %></td>
            <td><a href="Edit_AdminWomen_Image.jsp?Product_id=<%=rs.getString("Product_Id")%> &Color=<%=rs.getString("ColorName")%> &Filename=<%=rs.getString("Filename")%>">Edit Image</a></td>
