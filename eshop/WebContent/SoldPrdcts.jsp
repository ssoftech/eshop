...
<body>
	...
	<div id="container">
		...
		<div id="profileContent">
			...
			String sql="Select a1.Product_Id, a2.BrandName, a2.Category, a2.Quantity, a4.Order_Date, a4.Status from retailer_productinsertmen a1 inner join order_details a2 on a1.Product_Id=a2.Product_Id join retailer_register a3 on a1.Retailer_Name=a3.FirstName join order_table a4 on a2.Order_No=a4.Order_No and a3.Email=? ";
