...
<body>
	...
	<table id="im"
		...
		<%
				...
				String sql = "Select Filename, Product_Id from retailer_imageinsrt_kids where Product_Id=? and ColorName=?";
		...
		<tr>
			<td><a
				href="Show_RetailerImageEditKids.jsp?Filename=<%=rs.getString("Filename")%> &Products_Id=<%=rs.getString("Product_Id")%>"><%=rs.getString("Filename")%></a></td>
		</tr>
