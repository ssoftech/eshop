		...
		<div class="row">
			...
			<div id="MainMenu" class="col-xs-12 col-sm-5 col-md-3"
				...
				<div class="list-group panel pull-left" style="width: 99%;">
					...
					<a href="ViewOwnProducts_Retailer.jsp" class="list-group-item list-group-item-success" data-parent="#MainMenu"
					...
					<div
						...
						<div class="tab-content">
							<div id="AddPrd" class="tab-pane fade in active">
								...
								<br><br>
								<form action="Retailer_Men_Insrt_Prdct"  method="post" class="form-horizontal" id="AddProducts" role="form">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<input type="text" class="form-control" id="Product_SoldBy" name="Product_SoldBy"
												placeholder="Retailer Name" value="<%=name%>" readonly="readonly"></div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-sm-9">
											<select class="form-control" id="Category_MenWear" name="Category_MenWear" onchange="show(this.value)">
							...
							<div id="AddCol" class="tab-pane fade">
								...
								<br></br>
								<form action="Retailer_Men_InsertColor" method="post" class="form-horizontal" role="form">
									<div class="form-group">
										<label class="control-label col-sm-3" for="category"
									...
									String sql4 = "Select Product_Id from retailer_productinsertmen a1 inner join Retailer_Register a2 on a1.Retailer_Name=a2.FirstName and a2.Email=? ";
							...
							<div id="AddImg" class="tab-pane fade">
								...
								<form action="Retaler_Men_InsertImage" method="post" class="form-horizontal" role="form" enctype="multipart/form-data">
									<div class="form-group">
										<label class="control-label col-sm-3" for="category"
											style="text-align: left;">Product:</label>
										<div class="col-sm-9">
									...
									String sql5 = "Select Product_Id from retailer_productinsertmen a1 inner join Retailer_Register a2 on a1.Retailer_Name=a2.FirstName and a2.Email=? ";
									ps5 = con5.prepareStatement(sql5);
									ps5.setString(1,email);
									ResultSet rs5 = ps5.executeQuery();
									while (rs5.next()) {
								%>
								<option value="<%=rs5.getString("Product_Id")%>"><%=rs5.getString("Product_Id")%></option>
