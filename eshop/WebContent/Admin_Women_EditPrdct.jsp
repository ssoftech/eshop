...
function show_details(str) {
    if (str.length == 0) { 
        ...
        xmlhttp.open("GET", "Edit_Details_AdminWomen.jsp?Product_Id="+str, true);
        xmlhttp.send();
    }
}
function show_color(str) {
    if (str.length == 0) { 
        ...
        xmlhttp.open("GET", "Edit_AdminDetails_ColorMen.jsp?Product_Id="+str, true);
        xmlhttp.send();
    }
}
function show_colorforimage(str)
{
    if (str.length == 0) { 
        ...
        xmlhttp.open("GET", "Edit_Details_ImageWomenColor.jsp?Product_Id="+str, true);
        xmlhttp.send();
    }
...
function show_image_name(str)
{
    ...
    if (str.length == 0) { 
        ...
        xmlhttp.open("GET", "Edit_Details_WomenImage.jsp?Color="+str+"&Product_Id="+Product_Id, true);
        xmlhttp.send();
    }
...
function show_size(str) 
{
	...
	if (str.length == 0) {
		...
		xmlhttp.open("GET", "Edit_AdminWomenDetails_Size.jsp?Color=" + str
...
<body>
	...
	<div id="container"><!-- This is wrapper div -->
		...
		<div id="content"><!-- This is the content div -->
            ...
            <form method="post" action="Admin_Women_EditPrdct">
            ...
            <td style="padding-left: 5%;"><select name="Product_Id" onchange="show_details(this.value)" >
					...
					String sql="Select Product_Id from admin_productinsert_women";
		...
		<form action="Admin_Women_Edit_ColorPrdct" method="post">
			<table id="Color_Table"
					style="width:49.3%; height:230px; margin-top:13px;" cellspacing="4" align="center">
						...
						<td colspan="2"><select name="Product_Id"
							onchange="show_color(this.value)" style="margin-left: -2%;">
								...
								<%
									...
									String sql2 = "Select Product_Id from admin_productinsert_women";
					...
					<tr>
						<td colspan="2">
							<table id="color" style="margin-left: 10.8%;" cellspacing="3">
								<tr>
			...
			<td><select  name="Image_Table2" id="Image_Table2" onchange="show_colorforimage(this.value)" >
					...
					String sql5="Select Product_Id from admin_productinsert_women";
