			...
			<table>
				<tr
					...
					<td style="padding-left: 11.3%; position: static; z-index: 9999;"
						id="image"><img
						src="Image_SmallWomen?pid=<%=Product_id%> &FileName=<%=filename%>" height="400" width="310"></img></td>
				</tr>
				<tr id="subThumb">
					<td
						...
						<%
							...
							String sql3 = "Select DISTINCT Filename from retailer_imageinsrt_women where Product_Id=? AND Filename!=? AND ColorName=?";
						...
						href="WomenRed.jsp?Pid=<%=Product_id%> &Category=<%=category%> &Filename=<%=file%> &Price=<%=price%> &Colorname=<%=Color%>"><img
							src="Image_SmallWomen?pid=<%=Product_id%> &FileName=<%=file%>"
