...
<body>
	...
	<div id="container">
		...
		<div id="content" style="width: 99%; margin-left: 0.25%; overflow: scroll; overflow-x: hidden;">
			<!-- This is the content div -->
			<table id="status_prdcts" class="ViewUserAdmin" rules="cols" style="width: 98%; text-align: center; border: 1px solid black; margin-left: 1%; margin-right: 1%;">
				...
				%>
				<tr>
					<td style="padding:4px 1px 4px 2px; font-size: 14px;"><%=ob.getFirstName()%></td>
					<td style="padding:4px 1px 4px 2px; font-size: 14px;"><%=ob.getLastName()%></td>
					<td style="padding:4px 1px 4px 2px; font-size: 14px;"><%=ob.getEmail()%></td>
					<td style="padding:4px 1px 4px 2px; font-size: 14px;"><%=ob.getPhoneNo()%></td>
					<td style="padding:4px 1px 4px 2px; font-size: 14px;"><%=ob.getState()%></td>
					<td style="padding:4px 1px 4px 2px; font-size: 14px;"><%=ob.getCity()%></td>
					<td style="padding:4px 1px 4px 2px; font-size: 14px;"><%=ob.getAddProof()%></td>
					<td style="padding:4px 1px 4px 2px; font-size: 14px;"><%=ob.getIdProof()%></td>
				</tr>
				<%
					}
