...
<div class="container-fluid">
		...
		<div class="row">
			...
			ArrayList<Retailer_Men_Image> ar= new ArrayList<Retailer_Men_Image>();
			ar=Model_RtlMen_ImageForEdit.ViewImageForEdit(Filename, Product);
			Iterator<Retailer_Men_Image> it= ar.iterator();
			...
			<td class="text-center" style="padding-top:3px; padding-bottom:3px;"><img
						src="Show_RetailerImage?FileName=<%=obj.getFilename()%>"
						height="150" width="130" alt="kk" class="img-thumbnail" data-imagezoom="true"></td>
			
			<td class="text-center"><a href="Edit_RetailerImage.jsp?Product_id=<%=obj.getProduct_Id()%> &Color=<%=obj.getColor()%> &Filename=<%=obj.getFilename()%>"><i class="fa fa-pencil fa-2x"></i></a></td>
			<% 
			}
			%>
			</tr>
