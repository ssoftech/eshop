	...
	<div id="ShirtThumbTable" class="ShirtThumb1">
		...
		<table>
			...
			<%
				...
				String sql3 = "Select DISTINCT Filename from retailer_imageinsrt_women where Product_Id=?  AND ColorName=?";
			...
			%>
			<tr>
				<td style="padding-left: 18%;" id="image"><img
					src="Image_diffwomen_color?pid=<%=Product_id%> &ColorName=<%=Color%>"
			...
			%><tr>
				<td
					style="padding-top: 1.3%; padding-left: 2.7%; position: absolute; background: white;">
					<%
						} else {
					%> <%
 	String file = rs3.getString("Filename");
 %> <a
					href="WomenRed.jsp?Pid=<%=Product_id%> &Category=<%=category%> &Filename=<%=file%> &Price=<%=price%> &Colorname=<%=Color%>"><img
						src="Image_diffwomen_color12?pid=<%=Product_id%> &ColorName=<%=Color%> &file=<%=file%>"
		...
		<div class="Details1">
			<table style="margin-left: 0px; margin-top: 3px; position: relative;"
				...
				<%
					...
					String sql9 = "Select  BrandName,Tagline,Price from retailer_productinsertwomen where Product_Id=? ";
			...
			<table
				...
				<tr>
					<td><a href="#" style="color: olive;"><%=Color%></a>&nbsp <%
						...
						String sql4 = "Select DISTINCT ad1.ColorName,ad2.Product_Id  from retailer_colorinsertwomen ad1 inner join retailer_imageinsrt_women ad2 on ad1.Product_Id=ad2.Product_Id and ad2.Product_Id=? and ad1.ColorName!=? ";
					...
					%><a
						href="WomenShirtsColor.jsp?Pid=<%=Product_id%> &Colorname=<%=color%>  &Price=<%=price%> &Category=<%=category%>"><%=color%></a>
						<%
							}
						%></td>
				</tr>
				...
				<tr>
					<td>
						<%
							...
							String sql5 = "Select  Size from retailer_sizeinsrt_women where Product_Id=? and ColorName=?";
	...
	<div id="ProDetTable" class="ProDet">
		...
		<table border="1" rules="rows"
			...
			<%
				...
				String sql6 = "Select Category, Type, BrandName, Fittings, Price, About, Tagline from retailer_productinsertwomen where Product_Id=? ";
