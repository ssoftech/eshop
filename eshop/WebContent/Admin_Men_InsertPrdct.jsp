...
<script type="text/javascript">
	...
	<div id="container">
		...
		<div id="content">
			...
			<form action="Admin_Men_InsertPrdct" method="post">
				<%
			...
			<form action="Admin_Men_InsertColor" method="post">
			...
			<form action="Admin_Men_InsertImage" method="post"
						...
						<td><select name="Image_Table2" id="Image_Table2"
							onchange="show_colorforimage(this.value)">
								...
								<%
									...
									String sql6 = "Select Product_Id from admin_productinsert_men";
