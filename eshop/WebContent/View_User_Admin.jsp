...
<body>
	...
	<div id="container">
		...
		<div id="content" style="overflow: scroll; overflow-x: hidden;">
			...
			<table id="status_prdcts" rules="cols" class="ViewUserAdmin" style="width: 98%; margin-left: 1%; table-layout: fixed; border: 1px solid black; text-align: center; margin-top: 0.7%;">
				...
				<%
					ArrayList<User_Register> arr = Model.View_User_Admin.User_Admin();
					if (arr != null) {
						Iterator<User_Register> it = arr.iterator();

						while (it.hasNext()) {
							User_Register ob = it.next();
				%>
				<tr style="height: 40px;">
					<td style="word-break:break-all;"><%=ob.getFirstName()%></td>
					<td style="word-break:break-all;"><%=ob.getLastName()%></td>
					<td style="word-break:break-all;"><%=ob.getEmail()%></td>
					<td style="word-break:break-all;"><%=ob.getPhoneNo()%></td>
					<td style="word-break:break-all;"><%=ob.getState()%></td>
					<td style="word-break:break-all;"><%=ob.getCity()%></td>
				</tr>
				<%
					}
