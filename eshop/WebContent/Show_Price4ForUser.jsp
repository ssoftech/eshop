...
<table id="body6b">
				<%
					...
					String sql = "Select  DISTINCT ad1.Product_Id, ad1.ColorName from admin_imageinsrt_men ad1 inner join admin_productinsert_men ad2 on ad1.Product_Id=ad2.Product_Id and ad2.Price>='2000.00' And ad2.Price<='2499.00' and Category=? and Type=?";
