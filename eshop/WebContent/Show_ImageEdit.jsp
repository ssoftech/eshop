	...
	<div id="container"><!-- This is wrapper div -->
		...
		<div id="content"><!-- This is the content div -->
           ...
           <table  id="show_imageedit" cellspacing="8" >
			...
			String sql="Select * from admin_imageinsrt_men where Filename=?";
            ...
            <td><img src="Show_Image?FileName=<%=rs.getString("Filename")%>" height="130" width="130"  alt="kk" class="thumbnail"></td>
            <td><%=rs.getString("Filename") %></td>
            <td><a href="Edit_Image.jsp?Product_id=<%=rs.getString("Product_Id")%> &Color=<%=rs.getString("ColorName")%> &Filename=<%=rs.getString("Filename")%>">Edit Image</a></td>
