...
<body>
	...
	<%
		...
		String sql3 = "Select * from retailer_colorinsertmen where Product_Id=?";
	...
	%>
	      ...
	      <form action="Retailer_Men_Edit_Color" method="post">
			<div class="form-group">
									 ...
									 <div class="col-sm-4">
									   <input type="text" class="form-control size" id="Quantity2" name="Quantity" placeholder="Quantity 2" value="<%=rs3.getString("Quantity")%>">
									 </div>
									 <div class="col-sm-4">
